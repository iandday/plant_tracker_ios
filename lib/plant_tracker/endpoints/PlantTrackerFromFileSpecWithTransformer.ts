 ...
 */
export const trackerApiViewLocationDeleteLocation = (locationId: string) => {
...
export const getTrackerApiViewAreaGetAreaQueryKey = (areaId: string) => {
 ...
 * @summary Patch Area
 */
export const areaPatchArea = (areaId: string, areaPatch: AreaPatch) => {
  return customInstance<AreaOut>({
    url: `/api/area/${areaId}`,
    method: "PATCH",
    headers: { "Content-Type": "application/json" },
 ...
 * @summary Delete Area
 */
export const trackerApiViewAreaDeleteArea = (areaId: string) => {
  return customInstance<DeleteStatus>({
    url: `/api/area/${areaId}`,
    method: "DELETE",
  });
...
export const getTrackerApiViewPlantGetPlantQueryKey = (plantId: string) => {
 ...
 */
export const trackerApiViewPlantDeletePlant = (plantId: string) => {
  return customInstance<DeleteStatus>({
    url: `/api/plant/${plantId}`,
    method: "DELETE",
  });
...
export const getTrackerApiViewEntryGetEntryQueryKey = (entryId: string) => {
 ...
 */
export const trackerApiViewEntryDeleteEntry = (entryId: string) => {
  return customInstance<DeleteStatus>({
    url: `/api/entry/${entryId}`,
    method: "DELETE",
  });
